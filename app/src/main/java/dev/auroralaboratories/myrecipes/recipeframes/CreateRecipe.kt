...
import dev.auroralaboratories.myrecipes.uicomponents.IngredientRow
    ...
    Column(
        ...
        Column(
            ...
            AuroraInputField(
                ...
                onValueChange = { viewModel.updateServings(it.toIntOrNull()) },
                label = "Servings",
                modifier = Modifier.fillMaxWidth()
            )
            AuroraInputField(
                value = prepTimeMinutes?.toString() ?: "",
                onValueChange = { viewModel.updatePrepTimeMinutes(it.toIntOrNull())},
